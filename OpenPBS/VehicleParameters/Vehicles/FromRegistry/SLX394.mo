...
record SLX394 = OpenPBS.VehicleParameters.Base.UnitSpecification (
    n_axles=3,
    n_wheels=10,
    max_payload_mass=0,
    ...
    tyre_dimension1={385.0,385.0,295.0,295.0,295.0,295.0,295.0,295.0,295.0,
        295.0},
    ...
    max_thrust_vx0=150000.0) annotation (Icon(coordinateSystem(
